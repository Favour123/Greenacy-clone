...
export const servicesData: ServiceItem[] = [
   {
      ...
      description:
         "We equip students and teachers with the fundamentals of climate science, sustainability, and eco-friendly practices through engaging, age-appropriate workshops and interactive sessions.",
   },
   {
      id: "2",
      number: "02",
